...
assert.ok(puzzles.every(p=>p.words.length===10),'default puzzle should contain only 8–12 words');
assert.ok(puzzles.every(p=>p.blocks.length===4),'keep explicit grey unused blocks');
